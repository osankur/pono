...
class QIC3IAUnitTests : public ::testing::Test,
...
// TEST_P(QIC3IAUnitTests, SimpleSystemSafe)
// {
...
// TEST_P(QIC3IAUnitTests, SimpleSystemUnsafe)
// {
//   FunctionalTransitionSystem fts(s);
//   Term s1 = fts.make_statevar("s1", boolsort);
//   Term s2 = fts.make_statevar("s2", boolsort);
...
// TEST_P(QIC3IAUnitTests, CounterSystemUnsafe)
// {
//   FunctionalTransitionSystem fts(s);
...
// TEST_P(QIC3IAUnitTests, InductiveIntSafe)
// {
//   FunctionalTransitionSystem fts(s);
...
// TEST_P(QIC3IAUnitTests, SimpleIntSafe)
// {
...
TEST_P(QIC3IAUnitTests, IntegerSystem)
{
  RelationalTransitionSystem rts(s);
  Term x = rts.make_statevar("x", intsort);
  Term y = rts.make_statevar("y", intsort);
